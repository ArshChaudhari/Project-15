...
//creating continous balloons
  ...
  if (redballoonGroup.collide(arrowGroup)) {
    arrowGroup.destroyEach();
    redballoonGroup.destroyEach();
    score=score-2;  
  }

  if (greenballoonGroup.collide(arrowGroup)) {
    arrowGroup.destroyEach();
    greenballoonGroup.destroyEach();
    score=score+3;  
  }
  
  if (pinkballoonGroup.collide(arrowGroup)) {
    arrowGroup.destroyEach();
    pinkballoonGroup.destroyEach();
    score=score+1;  
  }
  
  if (blueballoonGroup.collide(arrowGroup)) {
    arrowGroup.destroyEach();
